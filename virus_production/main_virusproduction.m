...
if cell_line == 1 % MDCK cells
    ...
    r_dispersion = 0.628153003970294; % as of 05/11/20
    
    % time-dependent death rate best-fit parameter values
    % Weibull model parameters: [k,b] 
    deathrate_pars = [0.457318751306466, 0.301494847739504]; % as of 05/11/20
    ...
    % dispersion parameter of negative binomial
    r_dispersion = 0.351446407006261; % as of 05/11/20
    
    % constant death rate best-fit parameter value
    deathrate_pars = 0.0380280824075799; % as of 05/11/20
...
for k = 1:2 % can change to run time-independent or time-dependent only
