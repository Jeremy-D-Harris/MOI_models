function sample_param_var_estimate = get_var_poisson(log_alpha, n_pts_allphi_FACs, moi_vector_3hpi, moi_vector, all_hpi, data_allhpi, FACs_data_18hpi, model_num)
...
for n = 1:length(all_hpi)
    ...
    if n ==4
        ...
        for k = 1:length(these_moi_vals)
            ...
            var_estimate(1,counter_var) = (this_datum - get_percentalive(alpha, this_hpi, this_moi, alpha(end), model_num, which_distribution))^2;
