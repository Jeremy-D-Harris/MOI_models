  function void = main_estimate_superinfection(void)
...
params_fixed.prob_infected_cell_dead_19hpi = 1-exp(-(19/params_fixed.lambda)^params_fixed.death_k);
params_fixed.prob_infected_cell_dead_6hpi = 1-exp(-(6/params_fixed.lambda)^params_fixed.death_k)
...
results_super.est_actual_moi_rH3N1 = 10.^[-2:0.1:2];
[results_super.est_superinfection_H3_positive_percent_const, results_super.est_superinfection_H1_positive_percent_const, results_super.est_superinfection_H3_positive_H1_positive_percent_const] = GetEstimated_percents_superinfection_sim_fraction(results_super.est_actual_moi_rH3N1, paramsfit_co, model_num, paramsfit_super(1), params_fixed);
...
% get percent positive curves with best-fit parameters
[results_super.est_superinfection_H3_positive_percent_prop, results_super.est_superinfection_H1_positive_percent_prop, results_super.est_superinfection_H3_positive_H1_positive_percent_prop] = GetEstimated_percents_superinfection_sim_fraction(results_super.est_actual_moi_rH3N1, paramsfit_co, model_num, paramsfit_super(2), params_fixed);
