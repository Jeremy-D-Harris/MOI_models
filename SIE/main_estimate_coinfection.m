...
params_fixed.death_b = 0.302; % scale parameter of Weibull hazard - alpha(t,i) = bk(t^(k-1))
params_fixed.death_k = 0.457; % shape parameter of Weibull hazard

params_fixed.lambda = exp(log(params_fixed.death_b)/(-params_fixed.death_k));
params_fixed.prob_infected_cell_dead_by19hpi = 1-exp(-(19/params_fixed.lambda)^params_fixed.death_k);
...
results_co.est_actual_moi_rH3N1 = 10.^[-2:0.1:2];

[results_co.est_coinfection_H3_positive_percent, results_co.est_coinfection_H1_positive_percent, results_co.est_coinfection_H3_positive_H1_positive_percent] = GetEstimated_percents_coinfection_sim_fraction(results_co.est_actual_moi_rH3N1, paramsfit_co, params_fixed);
